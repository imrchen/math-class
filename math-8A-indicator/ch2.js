  ...
  window.DECK.push({
    ...
    slides: [
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 82', BLU, '化為最簡根式',
              ...
              pItem('印8 ③', '\\sqrt{27}\\times\\sqrt{6}', '\\(9\\sqrt{2}\\)')) +
            pCard('習作・基礎練習', '印 23', AMB, '判斷哪一個是最簡根式',
              pText('基礎1', '四個選項：\\(\\tfrac{1}{\\sqrt{6}}\\)、\\(\\sqrt{6}\\)、\\(\\sqrt{12}\\)、\\(\\sqrt{0.5}\\)。', '\\(\\sqrt{6}\\)')), '2-2');
        },
        caption: '習作那一題把兩個判準都考了：分母有根號、根號裡有平方因數。'
      },
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 85', BLU, '已知 \\(\\sqrt{7}\\doteq 2.646\\)',
              ...
              pItem('印11 ②', '\\sqrt{28}', '\\(5.292\\)')) +
            pCard('習作・基礎練習', '印 24', AMB, '已知 \\(\\sqrt{10}\\doteq 3.162\\)，四捨五入到小數第二位',
              pItem('基礎3 ①', '\\sqrt{250}', '\\(15.81\\)') +
              pItem('基礎3 ②', '\\sqrt{0.009}', '\\(0.09\\)')), '2-2');
        },
        caption: '習作第二題要先把 \\(0.009\\) 寫成 \\(\\tfrac{9}{1000}\\)，化簡後才看得到 \\(\\sqrt{10}\\)。'
      },

      {
        sec: '2-2', secName: '根式的運算',
        title: '練習｜習作的乘、除與化簡（前三題）',
        points: [
          '乘法：前面的數相乘、根號裡的數相乘。',
          '除法：把兩個根號併成一個，再算裡面。',
          '最後一定要檢查有沒有化到最簡。'
        ...
        caption: '習作印 23 的基礎 2：一次練乘、除與化簡三件事。'
      },

      {
        sec: '2-2', secName: '根式的運算',
        title: '練習｜習作的乘、除與化簡（後三題）',
        points: [
          '乘法：前面的數相乘、根號裡的數相乘。',
          '除法：把兩個根號併成一個，再算裡面。',
        ...
        visual: (h) => {
          pMount(h,
            pCard('習作・基礎練習', '印 23、24', AMB, '化為最簡根式',
              ...
              pItem('基礎2 ⑥', '\\sqrt{69}\\div\\sqrt{3}', '\\(\\sqrt{23}\\)')), '2-2');
        },
        caption: '⑤ 併起來是 \\(\\sqrt{1600}\\)，根號整個消失，答案是整數。'
      },
...

      {
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 86', BLU, '判斷同類方根',
              pText('印12 ①', '\\(\\sqrt{8}\\)、\\(\\sqrt{18}\\)、\\(\\sqrt{27}\\)、\\(\\sqrt{50}\\) 中哪些是同類方根？', '\\(\\sqrt{8},\\sqrt{18},\\sqrt{50}\\)')) +
        ...
        caption: '習作基礎 5 的第三組要化兩次才看得出來，正是「先化簡再分類」的代表題。'
      },
...

      {
        ...
        caption: '最後一題要先各自有理化成 \\(\\tfrac{2\\sqrt{10}}{10}\\) 與 \\(\\tfrac{5\\sqrt{10}}{10}\\)，才看得出是同類。'
      },
...

      {
        ...
        caption: '習作基礎 7 的四題都在乘法公式那一層，老師帶做；精熟 1 行有餘力再挑戰。'
      },
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 99', BLU, '直角三角形與正方形',
              ...
              pText('印5 ②', '正方形 \\(ABCD\\) 邊長 \\(1\\)，求對角線 \\(\\overline{BD}\\)。', '\\(\\sqrt{2}\\)')) +
            pCard('習作・基礎練習', '印 27', AMB, '求缺邊',
              pText('基礎1 ①', '兩股 \\(9\\)、\\(12\\)，求斜邊。', '\\(15\\)') +
              pText('基礎1 ②', '一股 \\(6\\)、斜邊 \\(7\\)，求另一股。', '\\(\\sqrt{13}\\)')), '2-3');
        },
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 104、105', BLU, '生活中的直角三角形',
              ...
              pText('印11', '\\(2.6\\) 公尺的竹竿由離牆 \\(1\\) 滑到 \\(2.4\\)，頂端下滑幾公尺？', '\\(1.4\\) 公尺')) +
            pCard('習作・基礎練習', '印 28', AMB, '長方形坑洞（長 36、寬 27）',
              pText('基礎4 ①', '求對角線長。', '\\(45\\) 公分') +
              pText('基礎4 ②', '要用圓形鐵片蓋住它，直徑至少多少？', '\\(45\\) 公分')), '2-3');
        },
        caption: '習作那兩小題連在一起：先算出對角線，第二小題才答得出來。'
      },
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 100', BLU, '邊長 10 的正三角形',
              ...
              pText('印6 ②', '求它的面積。', '\\(25\\sqrt{3}\\)')) +
            pCard('習作・基礎練習', '印 27', AMB, '邊長 1 的正三角形',
              pText('基礎2 ①', '求 \\(\\overline{AH}\\)（\\(\\overline{BC}\\) 上的高）。', '\\(\\tfrac{\\sqrt{3}}{2}\\)') +
              pText('基礎2 ②', '求 \\(\\triangle ABC\\) 的面積。', '\\(\\tfrac{\\sqrt{3}}{4}\\)')), '2-3');
        },
        caption: '課本用邊長 10、習作用邊長 1，同一組動作做兩次，公式就記得住了。'
      },
...

      {
        ...
        title: '練習｜習作的坐標三角形',
        points: [
          '四小題連在一起：先求邊長，再求高，最後算面積。',
          '每一段距離都用同一個公式，代坐標時看清楚負號。',
          '面積 \\(=\\tfrac{1}{2}\\times\\) 底 \\(\\times\\) 高，底和高要配成一對。'
        ],
        formula: { label: '這一組在練<span class="pgref">課本 印 108 例 8</span>', tex: '\\overline{BC}=\\sqrt{(-3-1)^2+(0+4)^2}=\\sqrt{32}' },
        visual: (h) => {
          pMount(h,
        ...
        caption: '習作印 29 這一題是四步一組：邊長 → 高 → 面積，缺一步就接不下去。'
      },
...

      {
        ...
        visual: (h) => {
          pMount(h,
            pCard('課本・隨堂練習', '印 103', BLU, '數線上的直角三角形（課本延伸）',
              ...
              pText('印9 ②', '\\(\\overline{OE}=\\overline{OD}\\)、\\(E\\) 在原點右方，求 \\(E\\)。', '\\(6\\)')) +
        ...
        caption: '精熟兩題行有餘力再做；圓的部分只求圓心與距離，不做圓的面積。'
      },
